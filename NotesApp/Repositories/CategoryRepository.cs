...
public class CategoryRepository : ICategoryRepository {
    ...
    public async Task<bool> ExistsAsync(int id) => await _db.Categories.AnyAsync(c => c.Id == id);

    public async Task<bool> HasNotesAsync(int id) => await _db.Notes.AnyAsync(n => n.CategoryId == id);
