...
public class ApiError {
    ...
    public int StatusCode { get; set; }
    public static ApiError NotFound(string message) => new() { Message = message, StatusCode = 404 };
    public static ApiError BadRequest(string message, List<string>? errors = null) => new() { Message = message, Errors = errors ?? new(), StatusCode = 400 };
